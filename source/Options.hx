...
class SkinMenuOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		LoadingState.loadAndSwitchState(new SkinSelectState());
		return false;
	}
...
class BeatBumps extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.bump = !FlxG.save.data.bump;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Dynamic Mode " + (!FlxG.save.data.bump ? "off" : "on");
	}
}
